...
vals_prim = sapply(X = seq(from = 0, to = 8, by = 1), FUN = f_radius, lims = lims)
...
ArgList_ex1_1 = list(n_contam = n_contam, lims = lims, spread = spread, spread_radius = radius_approx, 
                       cont_level = cont_level, method_sp = method_sp, n_sp = 750, n_strata = c(750,1), 
...
ArgList_ex1_2 = list(n_contam = n_contam, lims = lims, spread = spread, spread_radius = radius_approx, 
                       cont_level = cont_level, method_sp = method_sp, n_sp = 75, n_strata = c(75,1), 
...
ArgList_ex1_3 = list(n_contam = n_contam, lims = lims, spread = spread, spread_radius = radius_approx, 
                       cont_level = cont_level, method_sp = method_sp, n_sp = 25, n_strata = c(25,1), 
                       by = by, LOC = LOC, fun = fun, case = case, m = m, M = M, m_sp = 30, 
                       method_det = method_det, bg_level = bg_level, geom = geom)

ArgList_ex1_4 = list(n_contam = n_contam, lims = lims, spread = spread, spread_radius = radius_approx, 
                       cont_level = cont_level, method_sp = method_sp, n_sp = 10, n_strata = c(10,1), 
                       by = by, LOC = LOC, fun = fun, case = case, m = m, M = M, m_sp = 75, 
                       method_det = method_det, bg_level = bg_level, geom = geom)
```
...
```{r, warning = FALSE}
data_cleaned = metrics_cont_sec(data = sim_data1, vals_prim = vals_prim, vals_sec = c("increments(n=750, m=1)", "grab (n=75, m= 10)", "grab (n=30, m= 25)","grab(n=10,m=75)"), n_seed = n_seed)
```
...
plot_tune2_ribbon_P_det = function(data, xlab, legend_lab){
  ...
  b = ggplot(data = a) +
    ...
    scale_fill_manual(name = legend_lab,values=c("black","orange","skyblue","darkgreen"), limits=c("increments(n=750, m=1)", "grab (n=75, m= 10)", "grab (n=30, m= 25)","grab(n=10,m=75)")) +
    scale_color_manual(name = legend_lab,values=c("black","orange","skyblue","darkgreen"),limits=c("increments(n=750, m=1)", "grab (n=75, m= 10)", "grab (n=30, m= 25)","grab(n=10,m=75)")) +
